...
bech32_templates = [
  ...
  ('dfc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('dfc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('dfc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('dfc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tdfc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdfc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdfc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdfc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tdfc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdfc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdfc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdfc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rdfc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rdfc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rdfc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rdfc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tdfc',   17, 32, Encoding.BECH32M, False, False, False),
  ('rdfc',  3,  1, Encoding.BECH32M, False, False, False),
  ('dfc',   15, 41, Encoding.BECH32M, False, False, False),
  ('tdfc',    0, 16, Encoding.BECH32,  False, False, False),
  ('rdfc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('dfc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tdfc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rdfc',  0, 20, Encoding.BECH32,  False, False, True),
  ('dfc',    0, 20, Encoding.BECH32M, False, False, False),
  ('tdfc',    0, 32, Encoding.BECH32M, False, False, False),
  ('rdfc',  0, 20, Encoding.BECH32M, False, False, False),
  ('dfc',    1, 32, Encoding.BECH32,  False, False, False),
  ('tdfc',    2, 16, Encoding.BECH32,  False, False, False),
  ('rdfc', 16, 20, Encoding.BECH32,  False, False, False),
]
