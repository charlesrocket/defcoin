...
The Defcoin Core project operates an open contributor model where anyone is
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/defcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to defcoin-qt
...
The following applies to code changes to the Defcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Defcoin
Network Protocol consensus changes.

Whether a pull request is merged into Defcoin Core rests with the project merge
...
Patches that change Defcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Defcoin consensus, it must have been
...
The project leader is the release manager for each Defcoin Core release.
