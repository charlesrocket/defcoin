...
"""Verify that starting defcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start defcoin with -h for help text")
        ...
        self.log.info("Start defcoin with -version for version information")
        ...
        self.log.info("Start defcoind with -fakearg to make sure it does not start")
